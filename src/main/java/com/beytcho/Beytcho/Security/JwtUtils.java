...
public class JwtUtils {
    ...
    private static final long EXPIRATION_TIME_IN_MILLISECONDS =1000L*60L*60L*25L*30L*6L; // expire in 6 months
    private SecretKey key;
    @Value("${secretJwtString}")
    private String secretJwtString;//make sure value in app props is at least 32 characters
